...
CREATE TABLE `t_api_resource`  (
  `api_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
...
-- ----------------------------
INSERT INTO `t_api_resource` VALUES (1, '量子密钥管理', NULL, 0, '量子密钥相关', now(), now());
INSERT INTO `t_api_resource` VALUES (2, '获取量子随机数', 'GenerateRandom', 1, '生成指定大小的量子随机数', now(), now());
INSERT INTO `t_api_resource` VALUES (3, '获取量子密钥', 'GenerateTempKey', 1, '获取指定大小的量子密钥', now(), now());
...
CREATE TABLE `t_app`  (
  `app_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
...
CREATE TABLE `t_device_auth`  (
  `auth_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
  `device_id` int(20) NOT NULL COMMENT '终端用户id',
...
CREATE TABLE `t_device_operation`  (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
  `device_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '终端用户名',
...
CREATE TABLE `t_device_status`  (
  ...
  `device_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '终端名称',
...
CREATE TABLE `t_device_user`  (
  `device_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
  `device_name` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '终端用户名',
...
CREATE TABLE `t_group`  (
  `group_id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
...
CREATE TABLE `t_group_device_user`  (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT '主键,自增',
  `group_id` int(20) NULL DEFAULT NULL COMMENT '分组id',
  `device_id` int(20) NULL DEFAULT NULL COMMENT '终端用户id',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `t_ip`(`id`, `ip_info`, `create_time`) VALUES (1, '0.0.0.0/0', now());
...
INSERT INTO `t_user`(`id`, `user_name`, `password`, `email`, `create_time`, `update_time`, `comments`, `account_type`) VALUES (1, 'admin', 'AD1B04033BE0AAAE4E65EDA11C6F4F31', 'a@qtec.cn', now(), now(), '系统管理员', 9);
...
CREATE TABLE `t_user_app`  (
  ...
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '应用管理员与应用绑定表' ROW_FORMAT = Compact;
