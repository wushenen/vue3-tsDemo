package com.cucc.src.pairing.f.parameters;


import com.cucc.src.api.PairingParameters;
import com.cucc.src.util.io.Base64;
...
public class PropertiesParameters implements PairingParameters, Externalizable {
    ...
    public static final String VALUE_FOR_THE_FOLLOWING_KEY = "Cannot find value for the following key : ";
    ...
    public int getInt(String key) {
        ...
        if (value == null)
            throw new IllegalArgumentException(VALUE_FOR_THE_FOLLOWING_KEY + key);
