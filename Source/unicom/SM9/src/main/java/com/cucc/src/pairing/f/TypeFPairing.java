...
import com.cucc.src.field.poly.PolyElement;
import com.cucc.src.field.poly.PolyField;
import com.cucc.src.field.poly.PolyModElement;
import com.cucc.src.field.poly.PolyModField;
...
public class TypeFPairing extends AbstractPairing {
    ...
    public PolyModField getFp12() {
        return Fq12;
    }

    public PolyModField getFq4() {
        return Fq4;
    }
