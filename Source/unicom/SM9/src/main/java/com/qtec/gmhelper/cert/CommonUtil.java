...
import com.qtec.gmhelper.cert.exception.InvalidX500NameException;
...
public class CommonUtil {
    ...
    public static PKCS10CertificationRequest createCSR(X500Name subject, SM2PublicKey pubKey, PrivateKey priKey,
        ...
        //------------------------------------------
        PKCS10CertificationRequest pkcs10CertificationRequest = csrBuilder.build(signerBuilder);
        /*try {
			System.out.println("国密证书请求:"+Base64.toBase64String(pkcs10CertificationRequest.getEncoded()));
			//公钥
			String pub = Hex.toHexString(pkcs10CertificationRequest.getSubjectPublicKeyInfo().getPublicKeyData().getBytes());
