...
import com.qtec.unicom.controller.vo.AddRoleAppUserRequest;
...
public class RoleAppUserController {
    ...
    @ResponseBody
    public Result addAppRoleUser(@RequestBody AddRoleAppUserRequest addRoleAppUserRequest){
    ...
    @ResponseBody
    public Result deleteAppRoleUser(@RequestBody CancelRoleUserRequest cancelRoleUserRequest){
    ...
    @ResponseBody
    public Result roleAppUserList(@RequestParam("roleId") int roleId, HttpServletRequest request,
